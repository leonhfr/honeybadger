...
// zobristHash returns a hash (uint64)
//
...
func castleHash(pos *Position) (hash uint64) {
...
// 0 is returned.
func enPassantHash(pos *Position) (hash uint64) {
...
func turnHash(pos *Position) (hash uint64) {
	if pos.turn == White {
