...
func benchmarkNegamax(fen string, depth int, b *testing.B) {
	for n := 0; n < b.N; n++ {
		_, _ = negamax(context.Background(), Input{
...
func BenchmarkNegamax1(b *testing.B) {
	benchmarkNegamax("r1b1kb1r/pppp1ppp/2n1pq2/8/3Pn2N/2P3P1/PP1NPP1P/R1BQKB1R b KQkq - 3 6", 1, b)
}

func BenchmarkNegamax3(b *testing.B) {
	benchmarkNegamax("5rk1/pb2npp1/1pq4p/5p2/5B2/1B6/P2RQ1PP/2r1R2K b - - 0 1", 3, b)
}
